...
<main>
	<article>
		...
		<p class="text">
			That happens to me, too. So I built this website to make it easier to explore the different
			phases of the moon, plus a little notification robot to remind us all to go outside and look
			up at the world.
		</p>
		...
		<p class="text">
			The Moon Watching website relies on the excellent, open-source library <a
				href="https://github.com/cosinekitty/astronomy">Astronomy Engine</a
			>
			to calculate the position of the moon and other notable information. Astronomy Engine's calculations
			are based on the
			<a href="https://en.wikipedia.org/wiki/VSOP_(planets)">VSOP87</a> and
			<a href="https://aa.usno.navy.mil/software/novas/novas_c/novasc_info.php">NOVAS C 3.1</a>
			models and tested against NOVAS,
			<a href="https://ssd.jpl.nasa.gov/horizons.cgi">JPL Horizons</a>, and other reliable sources.
		</p>

		<!-- <h3 class="subheading">Emails</h3> -->
		<p class="text">
			Moon Watching emails rely on <a
				href="https://griffithobservatory.org/explore/observing-the-sky/whats-in-the-sky/the-moon/2023-phases-of-the-moon/"
				>data provided by the Griffith Observatory</a
			>
		...
		<p class="text">
			If you spot anything inconsistent, or want to chat about this project, please don't hesitate
			to reach out by <a href="mailto:dakotaATtinykitelabDOTcom">email.</a>
		</p>
	</article>
</main>
